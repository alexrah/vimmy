...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "8", function() vim.cmd "Kubectl get gateways.gateway.networking.k8s.io" end, ft = "k8s_*", desc = "Gateways" },
      { "<leader>k8", function() vim.cmd "Kubectl get gateways.gateway.networking.k8s.io" end, ft = "k8s_*", desc = "Gateways" },
