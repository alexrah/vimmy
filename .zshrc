...
plugins=(git github colored-man-pages bower gem web-search yum history-substring-search zsh-autosuggestions zsh-syntax-highlighting nvm kubectl helm wp-cli docker tmux npm zsh-python-venv-prompt autoswitch_virtualenv rust claudecode zsh-pnpm-completions zsh-kubectl-prompt)
...
#KUBERNETES
export KUBECONFIG=${HOME}/.kube/current.kubeconfig.yml:${HOME}/.kube/pct.kubeconfig.yml:${HOME}/.kube/pct-test.kubeconfig.yml:${HOME}/.kube/pct-dev-personal.kubeconfig.yml:${HOME}/.kube/kind-test.kubeconfig.yml:${HOME}/.kube/kind-test-ingress.kubeconfig.yml:${HOME}/.kube/vn-staging.kubeconfig.yml
