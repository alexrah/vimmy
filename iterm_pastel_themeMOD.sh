...
# Add display profile
defaults write net.sourceforge.iTerm Displays -dict-add PastelMod "$PASTELMOD"
echo "PastelMod display profile added"

# Set the default display profile
BOOKMARKS=`defaults read net.sourceforge.iTerm Bookmarks | sed 's/\("Display Profile" = \)"[^"]*";/\1"PastelMod";/'`
defaults write net.sourceforge.iTerm Bookmarks "$BOOKMARKS"
echo "PastelMod display profile installed as default"
